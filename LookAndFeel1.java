		...
		public void actionPerformed(ActionEvent e)
		 	{
				...
				else if (source == jbnMotif) laf = "com.sun.java.swing.plaf.motif.MotifLookAndFeel";
				else if (source == jbnWindows) laf= "com.sun.java.swing.plaf.windows.WindowsLookAndFeel";
				 try
 					{ 
				 ...
				 public static void main(String[] args) 
					{
						...
						Container contentPane = frame.getContentPane(); contentPane.add(new LookAndFeel1()); frame.setVisible(true); 
					} 					
	}